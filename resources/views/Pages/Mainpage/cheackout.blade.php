                    ...
                    <div class="row row-cols-md-2 ">
                        <div class="cold-md-6">
                            ...
                            <form action="{{ route('order.store') }}" method="POST">
                                ...
                                <input type="submit" class="btn btn-danger mt-5" value="Confirm Order">
                            </form>
                        </div>
                            ...
                            <div class="border ">
                                ...
                                @forelse($cheackout as $item)
                                    ...
                                    <div class="d-flex align-items-center p-3 border-bottom">
                                        ...
                                        <img src="{{ asset('storage/' . $item['photo']) }}" alt="" width="50">
                                        ...
                                        <div class="ms-3 flex-grow-1">
                                            ...
                                            <div class="more d-flex gap-5 mt-2 ">
                                                ...
                                                <a href="{{ route('addtocart.item.delete', $item['id']) }}"
                                                    class="text-danger fs-4 fw-bold"><i class="bi bi-x"></i></a>
                                            </div>
